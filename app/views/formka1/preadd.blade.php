                ...
                <form method="POST" action="{{$form_url}}" class="form-horizontal">
                  <!-- <div class="row"> -->
                      <!-- <section class="step" data-step-title="No LKA"> -->
                        ...
                        <div class="form-group has-primary">
                          {{ Form::label('tgl', 'Manual Tanggal',['class'=>'col-sm-3 control-label']) }}
                          <div class="col-sm-3">
                            <input  class="form-control" type="date"
                                    name="penomoran[tanggal]" ng-model="vm.tanggal" ng-change="vm.tanggalOnChange()"
                                    ng-required="!vm.isAuto" ng-disabled="vm.isAuto">
                                    <p class="help-block" style="text-align: justify">
                                    <strong>Keterangan</strong><br/>
                                       <strong>mm</strong> adalah Bulan dalam format 01 s/d 12<br/>
                                       <strong>dd</strong> adalah Hari dalam format 01 s/d 31<br/>
                                       <strong>yyyy</strong>   adalah Tahun dengan contoh 2015<br/>
                                   </p>
                          </div>
                        </div>
                        </span>
...
function PreAddController($scope, $http){
  ...
  function canIPass(){
    if (vm.isAuto == true){
      ...
      //disabled
      if (vm.readytanggal==true && vm.uniqueLKA==true){
        return true;
      } else {
        return false;
      }
